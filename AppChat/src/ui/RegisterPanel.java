...
public class RegisterPanel extends JPanel {
	...
	public RegisterPanel() {
		...
		lblDecoration1.setIcon(new ImageIcon(RegisterPanel.class.getResource("/resources/UI_ChapterIcon_MondstadtResized.png")));
		lblDecoration1.setBounds(141, 4, 64, 64);
		panel.add(lblDecoration1);
		
		JLabel lblDecoration2 = new JLabel("");
		lblDecoration2.setIcon(new ImageIcon(RegisterPanel.class.getResource("/resources/UI_ChapterIcon_LiyueResized.png")));
		lblDecoration2.setBounds(141, 72, 64, 64);
		panel.add(lblDecoration2);
		
		JLabel lblDecoration3 = new JLabel("");
		lblDecoration3.setIcon(new ImageIcon(RegisterPanel.class.getResource("/resources/UI_ChapterIcon_InazumaResized.png")));
		lblDecoration3.setBounds(141, 140, 64, 64);
		panel.add(lblDecoration3);
		
		JLabel lblDecoration4 = new JLabel("");
		lblDecoration4.setIcon(new ImageIcon(RegisterPanel.class.getResource("/resources/UI_ChapterIcon_SumeruResized.png")));
		lblDecoration4.setBounds(141, 208, 64, 64);
		panel.add(lblDecoration4);
		
		JLabel lblDecoration5 = new JLabel("");
		lblDecoration5.setIcon(new ImageIcon(RegisterPanel.class.getResource("/resources/UI_ChapterIcon_FontaineResized.png")));
		lblDecoration5.setBounds(141, 276, 64, 64);
		panel.add(lblDecoration5);
		
		JLabel lblDecoration5_1 = new JLabel("");
		lblDecoration5_1.setIcon(new ImageIcon(RegisterPanel.class.getResource("/resources/UI_ChapterIcon_NatlanResized.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(RegisterPanel.class.getResource("/resources/ProfilePic.png")));
